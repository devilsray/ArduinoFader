...
{
public:
  Fader(const int _pin, const int _processIntervalMillis = 40, const float _maxBrightness = 255, const float _stepsUpPerProcess = 1, const float _stepsDownPerProcess = 1);
